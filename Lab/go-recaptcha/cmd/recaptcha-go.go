...
<head>
<style>.error{color:#ff0000;} .ack{color:#0000ff;}
</style><title>Recaptcha Test</title>
...
func main() {
	...
	recaptchaPublicKey = "6LeVPN4UAAAAAKceUc88CvyFxc52-unnA2lAfVyN"
	recaptcha.Init("6LeVPN4UAAAAAFYYsewKaTq2F8oKZ_pG9sXR8GoI")
